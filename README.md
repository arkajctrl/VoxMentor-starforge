...
1. Clone this repository:
   `git clone https://github.com/arkajctrl/VoxMentor-starforge.git`
2. Install dependencies:
   `pip install -r requirements.txt`
3. Create a `.env` file and add your `RIME_API_KEY`.
4. Run the application:
   `streamlit run app.py`

## 4. Team
- **Fantastic 4 - Prithvi Raj Sahoo, Arkaj Patel, Aditya Saxena, Parkhi Chhabhra** 